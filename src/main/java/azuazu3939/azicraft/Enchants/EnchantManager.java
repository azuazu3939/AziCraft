...
public class EnchantManager {
                    ...
                    """
                            {
                              if ($2.i()) {
                                ...
                                return 0;
                              } else if (this.a == net.minecraft.world.item.enchantment.EnchantmentProtection.DamageType.b && S2.u()) {
                                return 0;
                                ...
                                return this.a == net.minecraft.world.item.enchantment.EnchantmentProtection.DamageType.e && $2.b() ? $0 * 0 : 0;
                              }
                            }"""
                    );
            return cc.toBytecode();
    ...
    public void reload() {
        ...
        queueClass("net.minecraft.world.damagesource.DamageSource", EnchantManager::rewriteEnchantProtectionClass);
