...
public class EnchantmentHealthBooster extends AbstractEnchantment {

    public EnchantmentHealthBooster(@NotNull String key) {
        super(key);
    }

    public static final Enchantment HEALTH_BOOSTER = new EnchantmentHealthBooster("health_booster");
